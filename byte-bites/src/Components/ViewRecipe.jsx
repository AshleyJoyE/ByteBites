        ...
        <div className={styles.heading}>
            <div className={styles.orangebox}>
                <div className={styles.div_header}>
                    <div className={styles.div_secondary_header}>
                        <div className={styles.div_tertiary_header}>
                    ...
                    <div className={styles.div_images_header}>
                        ...
                        <div className={styles.div_img_stars}>
                            <img className={styles.img_star} src="https://upload.wikimedia.org/wikipedia/commons/6/61/Black_bordered_yellow_star.svg">
                            </img>
                            <img className={styles.img_star} src="https://upload.wikimedia.org/wikipedia/commons/6/61/Black_bordered_yellow_star.svg">
                            </img>
                            <img className={styles.img_star} src="https://upload.wikimedia.org/wikipedia/commons/6/61/Black_bordered_yellow_star.svg">
                            ...
                            <img className={styles.img_star} src="https://upload.wikimedia.org/wikipedia/commons/8/82/Black_bordered_white_star.svg">
                            </img>
                        </div>
                ...
                <div className={styles.div_ingredients_instructions}>
                    ...
                    7. Although I prefer cookies fresh from the oven, these can be stored in an airtight container for up to 3 days.
                    </p>
                    </div>
                </div>
            </div>
